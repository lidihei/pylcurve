...
int main(int argc, char* argv[]){
    ...
    try{
        ...
        Lcurve::Model model(
                     ...
                     // disc
                      rdisc1_value,  rdisc1_range,  rdisc1_dstep,  rdisc1_vary,  rdisc1_defined, //disc
                     ...
                     //Bright-spot
                      radius_spot_value,  radius_spot_range,  radius_spot_dstep,  radius_spot_vary,  radius_spot_defined, //Bright-spot
                     ...
                     const char *slimb1, const char *slimb2,  mirror,  add_disc,  opaque,  add_spot,  nspot,  iscale
                    );
