...
class lcurve:
    ...
    def lc(self, times, expose=0, ndiv=1,
       ###Binary and stars
       q_value = 1,  q_range = 0.,  q_dstep = 0.,  q_vary = False,  q_defined = True,
       iangle_value = 90,  iangle_range = 0.,  iangle_dstep = 0.,  iangle_vary = False,  iangle_defined = True,
       r1_value = 0.1,  r1_range = 0.,  r1_dstep = 0.,  r1_vary = False,  r1_defined = True,
       r2_value = 0.1,  r2_range = 0.,  r2_dstep = 0.,  r2_vary = False,  r2_defined = True,
       cphi3_value = 0.,  cphi3_range = 0.,  cphi3_dstep = 0.,  cphi3_vary = False,  cphi3_defined = True,
       cphi4_value = 0.,  cphi4_range = 0.,  cphi4_dstep = 0.,  cphi4_vary = False,  cphi4_defined = True,
       ...
       teff1_value = 5000,  teff1_range = 0.,  teff1_dstep = 0.,  teff1_vary = False,  teff1_defined = True,
       teff2_value =  5000,  teff2_range = 0.,  teff2_dstep = 0.,  teff2_vary = False,  teff2_defined = True,
       ...
       velocity_scale_value = 323.4547,  velocity_scale_range = 0,  velocity_scale_dstep = 0,  velocity_scale_vary = False,  velocity_scale_defined = True,
       beam_factor1_value = 2.,  beam_factor1_range = 0.,  beam_factor1_dstep = 0.,  beam_factor1_vary = False,  beam_factor1_defined = True,
       beam_factor2_value = 1.3131,  beam_factor2_range = 0.,  beam_factor2_dstep = 0.,  beam_factor2_vary = False,  beam_factor2_defined = True,
       ##//General
       t0_value = 0,  t0_range = 0.,  t0_dstep = 0.,  t0_vary = False,  t0_defined = True,
       ...
       uesp_long1_value = 0.,  uesp_long1_range = 0.,  uesp_long1_dstep = 0.,  uesp_long1_vary = False,  uesp_long1_defined = False,
       uesp_long2_value = 0.,  uesp_long2_range = 0.,  uesp_long2_dstep = 0.,  uesp_long2_vary = False,  uesp_long2_defined = False,
       uesp_lathw_value = 0.,  uesp_lathw_range = 0.,  uesp_lathw_dstep = 0.,  uesp_lathw_vary = False,  uesp_lathw_defined = False,
       uesp_taper_value = 0.,  uesp_taper_range = 0.,  uesp_taper_dstep = 0.,  uesp_taper_vary = False,  uesp_taper_defined = False,
       uesp_temp_value = 0.,  uesp_temp_range = 0.,  uesp_temp_dstep = 0.,  uesp_temp_vary = False,  uesp_temp_defined = False,
       ##// disc
       rdisc1_value = 0.0,  rdisc1_range = 0.,  rdisc1_dstep = 0.,  rdisc1_vary = False,  rdisc1_defined = False,
       rdisc2_value = 0.0,  rdisc2_range = 0.,  rdisc2_dstep = 0.,  rdisc2_vary = False,  rdisc2_defined = False,
       ...
       info = True, parallel_threshold=4
        ...
        .
        .
        etc. The above would mean that q is not to be varied (as the penultimate q_vary=False), but iangle and r1 are. For simplex, genetic, simann and powell the *_range parameter specifies the range over which to vary the respective parameter (i.e. 0.01, 2 and 0.05 in this case), while the *_dstep parameter is used by levmarq to compute numerical derivatives using finite differences. Be careful to set this small enough to give accurate derivatives but not so small that roundoff will be problematic. It should, at a minimum, be smaller than the uncertainty in any parameter. The *_defined parameter is a relatively recent addition which specifies whether a given parameter is used at all and is designed for the star spot parameters. Here is the full list of parameters.
        ...
        glens1 [bool] --- Account for gravitational lensing by star 1. If you use this roche1 must be = 0 and the velocity_scale.
        ...
        self.logg1 [float] --- flux-weighted logg of star1
        self.logg2 [float] --- flux-weighted logg of star2
        self.rv1: [float] --- volume-averaged radius of star1
        self.rv2: [float] --- volume-averaged radius of star2
        '''
        #tt = time.time()
        Tsize = len(times)
    ...
    def lc_example(self, times, expose=0, ndiv=1,
       ###Binary and stars
       ...
       info = True, parallel_threshold=4
        ...
        .
        etc. The above would mean that q is not to be varied (as the penultimate q_vary=False), but iangle and r1 are. For simplex, genetic, simann and powell the *_range parameter specifies the range over which to vary the respective parameter (i.e. 0.01, 2 and 0.05 in this case), while the *_dstep parameter is used by levmarq to compute numerical derivatives using finite differences. Be careful to set this small enough to give accurate derivatives but not so small that roundoff will be problematic. It should, at a minimum, be smaller than the uncertainty in any parameter. The *_defined parameter is a relatively recent addition which specifies whether a given parameter is used at all and is designed for the star spot parameters. Here is the full list of parameters.
        details can also be found in lcurve.lc
        ...
        self.rv2: [float] --- volume-averaged radius of star2
        '''
        calc = self.lc(times, expose=0, ndiv=1,
            q_value = q_value,  q_range = q_range,  q_dstep = q_dstep,  q_vary = q_vary,  q_defined = q_defined,
            iangle_value = iangle_value,  iangle_range = q_range,  iangle_dstep = iangle_dstep,  iangle_vary = iangle_vary,  iangle_defined = iangle_defined,
            r1_value = r1_value,  r1_range = q_range,  r1_dstep = r1_dstep,  r1_vary = r1_vary,  r1_defined = r1_defined,
            r2_value = r2_value,  r2_range = q_range,  r2_dstep = r2_dstep,  r2_vary = r2_vary,  r2_defined = r2_defined,
            cphi3_value = cphi3_value,  cphi3_range = cphi3_range,  cphi3_dstep = cphi3_dstep,  cphi3_vary = cphi3_vary,  cphi3_defined = cphi3_defined,
            cphi4_value = cphi4_value,  cphi4_range = cphi4_range,  cphi4_dstep = cphi4_dstep,  cphi4_vary = cphi4_vary,  cphi4_defined = cphi4_defined,
            spin1_value = spin1_value,  spin1_range = spin1_range,  spin1_dstep = spin1_dstep,  spin1_vary = spin1_vary,  spin1_defined = spin1_defined,
            spin2_value = spin2_value,  spin2_range = spin2_range,  spin2_dstep = spin2_dstep,  spin2_vary = spin2_vary,  spin2_defined = spin2_defined,
            teff1_value = teff1_value,  teff1_range = teff1_range,  teff1_dstep = teff1_dstep,  teff1_vary = teff1_vary,  teff1_defined = teff1_defined,
            teff2_value = teff2_value,  teff2_range = teff2_range,  teff2_dstep = teff2_dstep,  teff2_vary = teff2_vary,  teff2_defined = teff2_defined,
            ldc1_1_value = ldc1_1_value,  ldc1_1_range = ldc1_1_range,  ldc1_1_dstep = ldc1_1_dstep,  ldc1_1_vary = ldc1_1_vary,  ldc1_1_defined = ldc1_1_defined,
            ldc1_2_value = ldc1_2_value,  ldc1_2_range = ldc1_2_range,  ldc1_2_dstep = ldc1_2_dstep,  ldc1_2_vary = ldc1_2_vary,  ldc1_2_defined = ldc1_2_defined,
            ldc1_3_value = ldc1_3_value,  ldc1_3_range = ldc1_3_range,  ldc1_3_dstep = ldc1_3_dstep,  ldc1_3_vary = ldc1_3_vary,  ldc1_3_defined = ldc1_3_defined,
            ldc1_4_value = ldc1_4_value,  ldc1_4_range = ldc1_4_range,  ldc1_4_dstep = ldc1_4_dstep,  ldc1_4_vary = ldc1_4_vary,  ldc1_4_defined = ldc1_4_defined,
            ldc2_1_value = ldc2_1_value,  ldc2_1_range = ldc1_1_range,  ldc2_1_dstep = ldc2_1_dstep,  ldc2_1_vary = ldc2_1_vary,  ldc2_1_defined = ldc2_1_defined,
            ldc2_2_value = ldc2_2_value,  ldc2_2_range = ldc2_2_range,  ldc2_2_dstep = ldc2_2_dstep,  ldc2_2_vary = ldc2_2_vary,  ldc2_2_defined = ldc2_2_defined,
            ldc2_3_value = ldc2_3_value,  ldc2_3_range = ldc2_3_range,  ldc2_3_dstep = ldc2_3_dstep,  ldc2_3_vary = ldc2_3_vary,  ldc2_3_defined = ldc2_3_defined,
            ldc2_4_value = ldc2_4_value,  ldc2_4_range = ldc2_4_range,  ldc2_4_dstep = ldc2_4_dstep,  ldc2_4_vary = ldc2_4_vary,  ldc2_4_defined = ldc2_4_defined,
            velocity_scale_value = velocity_scale_value,  velocity_scale_range = velocity_scale_range,  velocity_scale_dstep = velocity_scale_dstep,  velocity_scale_vary = velocity_scale_vary,  velocity_scale_defined = velocity_scale_defined,
            beam_factor1_value = beam_factor1_value,  beam_factor1_range = beam_factor1_range,  beam_factor1_dstep = beam_factor1_dstep,  beam_factor1_vary = beam_factor1_vary,  beam_factor1_defined = beam_factor1_defined,
            beam_factor2_value = beam_factor2_value,  beam_factor2_range = beam_factor2_range,  beam_factor2_dstep = beam_factor2_dstep,  beam_factor2_vary = beam_factor2_vary,  beam_factor2_defined = beam_factor2_defined,
            t0_value = t0_value,  t0_range = t0_range,  t0_dstep = t0_dstep,  t0_vary = t0_vary,  t0_defined = t0_defined,
            period_value = period_value,  period_range = period_range,  period_dstep = period_dstep,  period_vary = period_vary,  period_defined = period_defined,
            pdot_value = pdot_value,  pdot_range = pdot_range,  pdot_dstep = pdot_dstep,  pdot_vary = pdot_vary,  pdot_defined = pdot_defined,
            deltat_value = deltat_value,  deltat_range = deltat_range,  deltat_dstep = deltat_dstep,  deltat_vary = deltat_vary,  deltat_defined = deltat_defined,
            gravity_dark1_value = gravity_dark1_value,  gravity_dark1_range = gravity_dark2_range,  gravity_dark1_dstep = gravity_dark1_dstep,  gravity_dark1_vary = gravity_dark1_vary,  gravity_dark1_defined = gravity_dark1_defined,
            gravity_dark2_value = gravity_dark2_value,  gravity_dark2_range = gravity_dark2_range,  gravity_dark2_dstep = gravity_dark2_dstep,  gravity_dark2_vary = gravity_dark2_vary,  gravity_dark2_defined = gravity_dark2_defined,
            absorb_value = absorb_value,  absorb_range = absorb_range,  absorb_dstep = absorb_dstep,  absorb_vary = absorb_vary,  absorb_defined = absorb_defined,
            slope_value = slope_value,  slope_range = slope_range,  slope_dstep = slope_dstep,  slope_vary = slope_vary,  slope_defined = slope_defined,
            quad_value = quad_value,  quad_range = quad_range,  quad_dstep = quad_dstep,  quad_vary = quad_vary,  quad_defined = quad_defined,
            cube_value = cube_value,  cube_range = cube_range,  cube_dstep = cube_dstep,  cube_vary = cube_vary,  cube_defined = cube_defined,
            third_value = third_value,  third_range =  third_range,  third_dstep = third_dstep,  third_vary = third_vary,  third_defined = third_defined,
            stsp11_long_value = stsp11_long_value,  stsp11_long_range = stsp11_long_range,  stsp11_long_dstep = stsp11_long_dstep,  stsp11_long_vary = stsp11_long_vary,  stsp11_long_defined = stsp11_long_defined,
            stsp11_lat_value = stsp11_lat_value,  stsp11_lat_range = stsp11_lat_range,  stsp11_lat_dstep = stsp11_lat_dstep,  stsp11_lat_vary = stsp11_lat_vary,  stsp11_lat_defined = stsp11_lat_defined,
            stsp11_fwhm_value = stsp11_fwhm_value,  stsp11_fwhm_range = stsp11_fwhm_range,  stsp11_fwhm_dstep = stsp11_fwhm_dstep,  stsp11_fwhm_vary = stsp11_fwhm_vary,  stsp11_fwhm_defined = stsp11_fwhm_defined,
            stsp11_tcen_value = stsp11_tcen_value,  stsp11_tcen_range = stsp11_tcen_range,  stsp11_tcen_dstep = stsp11_tcen_dstep,  stsp11_tcen_vary = stsp11_tcen_vary,  stsp11_tcen_defined = stsp11_tcen_defined,
            stsp12_long_value = stsp12_long_value,  stsp12_long_range = stsp12_long_range,  stsp12_long_dstep = stsp12_long_dstep,  stsp12_long_vary = stsp12_long_vary,  stsp12_long_defined = stsp12_long_defined,
            stsp12_lat_value = stsp12_lat_value,  stsp12_lat_range = stsp12_lat_range,  stsp12_lat_dstep = stsp12_lat_dstep,  stsp12_lat_vary = stsp12_lat_vary,  stsp12_lat_defined = stsp12_lat_defined,
            stsp12_fwhm_value = stsp12_fwhm_value,  stsp12_fwhm_range = stsp12_fwhm_range,  stsp12_fwhm_dstep = stsp12_fwhm_dstep,  stsp12_fwhm_vary = stsp12_fwhm_vary,  stsp12_fwhm_defined = stsp12_fwhm_defined,
            stsp12_tcen_value = stsp12_tcen_value,  stsp12_tcen_range = stsp12_tcen_range,  stsp12_tcen_dstep = stsp12_tcen_dstep,  stsp12_tcen_vary = stsp12_tcen_vary,  stsp12_tcen_defined = stsp12_tcen_defined,
            stsp13_long_value = stsp13_long_value,  stsp13_long_range = stsp13_long_range,  stsp13_long_dstep = stsp13_long_dstep,  stsp13_long_vary = stsp13_long_vary,  stsp13_long_defined = stsp13_long_defined,
            stsp13_lat_value = stsp13_lat_value,  stsp13_lat_range = stsp13_lat_range,  stsp13_lat_dstep = stsp13_lat_dstep,  stsp13_lat_vary = stsp13_lat_vary,  stsp13_lat_defined = stsp13_lat_defined,
            stsp13_fwhm_value = stsp13_fwhm_value,  stsp13_fwhm_range = stsp13_fwhm_range,  stsp13_fwhm_dstep = stsp13_fwhm_dstep,  stsp13_fwhm_vary = stsp13_fwhm_vary,  stsp13_fwhm_defined = stsp13_fwhm_defined,
            stsp13_tcen_value = stsp13_tcen_value,  stsp13_tcen_range = stsp13_tcen_range,  stsp13_tcen_dstep = stsp13_tcen_dstep,  stsp13_tcen_vary = stsp13_tcen_vary,  stsp13_tcen_defined = stsp13_tcen_defined,
            stsp21_long_value = stsp21_long_value,  stsp21_long_range = stsp21_long_range,  stsp21_long_dstep = stsp21_long_dstep,  stsp21_long_vary = stsp21_long_vary,  stsp21_long_defined = stsp21_long_defined,
            stsp21_lat_value = stsp21_lat_value,  stsp21_lat_range = stsp21_lat_range,  stsp21_lat_dstep = stsp21_lat_dstep,  stsp21_lat_vary = stsp21_lat_vary,  stsp21_lat_defined = stsp21_lat_defined,
            stsp21_fwhm_value = stsp21_fwhm_value,  stsp21_fwhm_range = stsp21_fwhm_range,  stsp21_fwhm_dstep = stsp21_fwhm_dstep,  stsp21_fwhm_vary = stsp21_fwhm_vary,  stsp21_fwhm_defined = stsp21_fwhm_defined,
            stsp21_tcen_value = stsp21_tcen_value,  stsp21_tcen_range = stsp21_tcen_range,  stsp21_tcen_dstep = stsp21_tcen_dstep,  stsp21_tcen_vary = stsp21_tcen_vary,  stsp21_tcen_defined = stsp21_tcen_defined,
            stsp22_long_value = stsp22_long_value,  stsp22_long_range = stsp22_long_range,  stsp22_long_dstep = stsp22_long_dstep,  stsp22_long_vary = stsp22_long_vary,  stsp22_long_defined = stsp22_long_defined,
            stsp22_lat_value = stsp22_lat_value,  stsp22_lat_range = stsp22_lat_range,  stsp22_lat_dstep = stsp22_lat_dstep,  stsp22_lat_vary = stsp22_lat_vary,  stsp22_lat_defined = stsp22_lat_defined,
            stsp22_fwhm_value = stsp22_fwhm_value,  stsp22_fwhm_range = stsp22_fwhm_range,  stsp22_fwhm_dstep = stsp22_fwhm_dstep,  stsp22_fwhm_vary = stsp22_fwhm_vary,  stsp22_fwhm_defined = stsp22_fwhm_defined,
            stsp22_tcen_value = stsp22_tcen_value,  stsp22_tcen_range = stsp22_tcen_range,  stsp22_tcen_dstep = stsp22_tcen_dstep,  stsp22_tcen_vary = stsp22_tcen_vary,  stsp22_tcen_defined = stsp22_tcen_defined,
            uesp_long1_value = uesp_long1_value,  uesp_long1_range = uesp_long1_range,  uesp_long1_dstep = uesp_long1_dstep,  uesp_long1_vary = uesp_long1_vary,  uesp_long1_defined = uesp_long1_defined,
            uesp_long2_value = uesp_long2_value,  uesp_long2_range = uesp_long2_range,  uesp_long2_dstep = uesp_long2_dstep,  uesp_long2_vary = uesp_long2_vary,  uesp_long2_defined = uesp_long2_defined,
            uesp_lathw_value = uesp_lathw_value,  uesp_lathw_range = uesp_lathw_range,  uesp_lathw_dstep = uesp_lathw_dstep,  uesp_lathw_vary = uesp_lathw_vary,  uesp_lathw_defined = uesp_lathw_defined,
            uesp_taper_value = uesp_taper_value,  uesp_taper_range = uesp_taper_range,  uesp_taper_dstep = uesp_taper_dstep,  uesp_taper_vary = uesp_taper_vary,  uesp_taper_defined = uesp_taper_defined,
            uesp_temp_value = uesp_temp_value,  uesp_temp_range = uesp_temp_range,  uesp_temp_dstep = uesp_temp_dstep,  uesp_temp_vary = uesp_temp_vary,  uesp_temp_defined = uesp_temp_defined,
            rdisc1_value = rdisc1_value,  rdisc1_range = rdisc1_range,  rdisc1_dstep = rdisc1_dstep,  rdisc1_vary = rdisc1_vary,  rdisc1_defined = rdisc1_defined,
            rdisc2_value = rdisc2_value,  rdisc2_range = rdisc2_range,  rdisc2_dstep = rdisc2_dstep,  rdisc2_vary = rdisc2_vary,  rdisc2_defined = rdisc2_defined,
            height_disc_value = height_disc_value,  height_disc_range = height_disc_range,  height_disc_dstep = height_disc_dstep,  height_disc_vary = height_disc_vary,  height_disc_defined = height_disc_defined,
            beta_disc_value = beta_disc_value,  beta_disc_range = beta_disc_range,  beta_disc_dstep = beta_disc_dstep,  beta_disc_vary = beta_disc_vary,  beta_disc_defined = beta_disc_defined,
            temp_disc_value = temp_disc_value,  temp_disc_range = temp_disc_range,  temp_disc_dstep = temp_disc_dstep,  temp_disc_vary = temp_disc_vary,  temp_disc_defined = temp_disc_defined,
            texp_disc_value = texp_disc_value,  texp_disc_range = texp_disc_range,  texp_disc_dstep = texp_disc_dstep,  texp_disc_vary = texp_disc_vary,  texp_disc_defined = texp_disc_defined,
            lin_limb_disc_value = lin_limb_disc_value,  lin_limb_disc_range = lin_limb_disc_range,  lin_limb_disc_dstep = lin_limb_disc_dstep,  lin_limb_disc_vary = lin_limb_disc_vary,  lin_limb_disc_defined = lin_limb_disc_defined,
            quad_limb_disc_value = quad_limb_disc_value,  quad_limb_disc_range = quad_limb_disc_range,  quad_limb_disc_dstep = quad_limb_disc_dstep,  quad_limb_disc_vary = quad_limb_disc_vary,  quad_limb_disc_defined = quad_limb_disc_defined,
            temp_edge_value = temp_edge_value,  temp_edge_range = temp_edge_range,  temp_edge_dstep = temp_edge_dstep,  temp_edge_vary = temp_edge_vary,  temp_edge_defined = temp_edge_defined,
            absorb_edge_value = absorb_edge_value,  absorb_edge_range = absorb_edge_range,  absorb_edge_dstep = absorb_edge_dstep,  absorb_edge_vary = absorb_edge_vary,  absorb_edge_defined = absorb_edge_defined,
            radius_spot_value = radius_spot_value,  radius_spot_range = radius_spot_range,  radius_spot_dstep = radius_spot_dstep,  radius_spot_vary = radius_spot_vary,  radius_spot_defined = radius_spot_defined,
            length_spot_value = length_spot_value,  length_spot_range = length_spot_range,  length_spot_dstep = length_spot_dstep,  length_spot_vary = length_spot_vary,  length_spot_defined = length_spot_defined,
            height_spot_value = height_spot_value,  height_spot_range = height_spot_range,  height_spot_dstep = height_spot_dstep,  height_spot_vary = height_spot_vary,  height_spot_defined = height_spot_defined,
            expon_spot_value = expon_spot_value,  expon_spot_range = expon_spot_range,  expon_spot_dstep = expon_spot_dstep,  expon_spot_vary = expon_spot_vary,  expon_spot_defined = expon_spot_defined,
            epow_spot_value = epow_spot_value,  epow_spot_range = epow_spot_range,  epow_spot_dstep = epow_spot_dstep,  epow_spot_vary = epow_spot_vary,  epow_spot_defined = epow_spot_defined,
            angle_spot_value = angle_spot_value,  angle_spot_range = angle_spot_range,  angle_spot_dstep = angle_spot_dstep,  angle_spot_vary = angle_spot_vary,  angle_spot_defined = angle_spot_defined,
            yaw_spot_value = yaw_spot_value,  yaw_spot_range = yaw_spot_range,  yaw_spot_dstep = yaw_spot_dstep,  yaw_spot_vary = yaw_spot_vary,  yaw_spot_defined = yaw_spot_defined,
            temp_spot_value = temp_spot_value,  temp_spot_range = temp_spot_range,  temp_spot_dstep = temp_spot_dstep,  temp_spot_vary = temp_spot_vary,  temp_spot_defined = temp_spot_defined,
            tilt_spot_value = tilt_spot_value,  tilt_spot_range = tilt_spot_range,  tilt_spot_dstep = tilt_spot_dstep,  tilt_spot_vary = tilt_spot_vary,  tilt_spot_defined = tilt_spot_defined,
            cfrac_spot_value = cfrac_spot_value,  cfrac_spot_range = cfrac_spot_range,  cfrac_spot_dstep = cfrac_spot_dstep,  cfrac_spot_vary = cfrac_spot_vary,  cfrac_spot_defined = cfrac_spot_defined,
            delta_phase = delta_phase,  nlat1f = nlat1f,  nlat2f = nlat2f,  nlat1c = nlat1c,  nlat2c = nlat2c,  npole = npole,
            nlatfill = nlatfill,  nlngfill = nlngfill,  lfudge = lfudge,  llo = llo,  lhi = lhi,  phase1 = phase1,  phase2 = phase2,  nrad = nrad,  wavelength = wavelength,
            roche1 = roche1,  roche2 = roche2,  eclipse1 = eclipse1,  eclipse2 = eclipse2,  glens1 =  glens1,  use_radii=use_radii,
            tperiod = tperiod,  gdark_bolom1 = gdark_bolom1,  gdark_bolom2 = gdark_bolom2,  mucrit1 = mucrit2,  mucrit2 = mucrit2,
            slimb1 = slimb1, slimb2 = slimb2,  mirror = mirror,  add_disc = mirror,  opaque = opaque,  add_spot = add_spot,  nspot = nspot,  iscale = iscale,
            info = info, parallel_threshold=parallel_threshold)
        return calc
